...
class SearchAndReplaceAlgorithm(ChloeAlgorithm):
    ...
    def initAlgorithm(self, config=None):
        ...
        fieldsParam = QgsProcessingParameterFile(
            name=self.MAP_CSV, description=self.tr("CSV Map"), optional=True
        )
    ...
    def PreRun(self, parameters, context, feedback, executing=True):
        ...
        self.map_csv = self.parameterAsString(parameters, self.MAP_CSV, context)
        self.changes = self.parameterAsString(parameters, self.CHANGES, context)
