...
class SlidingMultiAlgorithmDialog(ChloeAlgorithmDialog):
    ...
    def __init__(self, alg):
        ...
        self.mainWidget = SlidingMultiParametersPanel(self, alg) # Main parameter windows
...
class SlidingMultiParametersPanel(ChloeParametersPanel):
