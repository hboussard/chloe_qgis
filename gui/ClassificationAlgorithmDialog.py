...
from .ClassificationTablePanel import ClassificationTablePanel
...
class ClassificationAlgorithmDialog(ChloeAlgorithmDialog):
    ...
    def __init__(self, alg):
        ...
        self.mainWidget = ClassificationParametersPanel(self, alg) # Main parameter windows
    ...
    def setParamValue(self, param, widget, alg=None):
        ...
        """
        if isinstance(widget, ClassificationTablePanel):
...
class ClassificationParametersPanel(ChloeParametersPanel):
    ...
    def connectParameterSignals(self):
        for w in self.widgets.values():
            ...
            elif isinstance(w, ClassificationTablePanel):
    ...
    def cleanFieldDependent(self):
        ...
        """
        for w in self.widgets.values():
            if isinstance(w, ClassificationTablePanel):
                w.leText.setText("")
    ...
    def getWidgetFromParameter(self, param):
        ...
        if param.name in ["DOMAINS"]:
            ...
            item = ClassificationTablePanel(self.parent, self.alg, param.default)
            if param.default:
