...
class ClusterAlgorithmDialog(ChloeAlgorithmDialog):
    ...
    def __init__(self, alg):
        ...
        self.mainWidget = ClusterParametersPanel(self, alg) # Main parameter windows
...
class ClusterParametersPanel(ChloeParametersPanel):
    ...
    def parametersHaveChanged(self):
        ...
        try:
            # hiding optional Cluster params when necessary
            clusterTypeWidget =  self.widgets["CLUSTER_TYPE"]
            clusterTypeWidgetValue = clusterTypeWidget.currentIndex()
            self.labels["CLUSTER_DISTANCE"].setVisible(clusterTypeWidgetValue in [2,3])
            self.widgets["CLUSTER_DISTANCE"].setVisible(clusterTypeWidgetValue in [2,3])

            self.labels["CLUSTER_FRICTION"].setVisible(clusterTypeWidgetValue in [3])
            self.widgets["CLUSTER_FRICTION"].setVisible(clusterTypeWidgetValue in [3])
