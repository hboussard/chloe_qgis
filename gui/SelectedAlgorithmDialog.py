...
class SelectedAlgorithmDialog(ChloeAlgorithmDialog):
    ...
    def __init__(self, alg):
        ...
        self.mainWidget = SelectedParametersPanel(self, alg) # Main parameter windows
...
class SelectedParametersPanel(ChloeParametersPanel):
